...
支持Qwen-3.5，Doubao-Seed-2.0，MiniMax-M2.7、MiniMax-M2.5，GLM-5.1、GLM-5、GLM-4.7，MiMo-V2-Pro，Kimi-K2.5，KAT-Coder-Pro V1，DeepSeek-V3.2等模型
...
以下对比基于各平台公开信息和用户反馈，仅供参考。

| 平台 | 价格 | 购买难度 | 稳定性 | 编程能力 | 文本能力 |
|------|------|------|------|------|------|
| 智谱AI | 中 | 无需抢购 | 稳定 | 强（GLM-5编程能力强） | 强（GLM系列文本能力强） |
| MiniMax | 低 | 无需抢购 | 稳定 | 中（M2.7编程能力强） | 中 |
| 字节·方舟 | 中 | Pro限量发售 | 稳定 | 强（Doubao-Seed-2.0） | 强 |
| 阿里·百炼 | 中 | Pro限量发售 | 稳定 | 强（Qwen-3.5编程能力强） | 强（Qwen系列文本能力强） |
| 小米·MiMo | 中 | 无需抢购 | 稳定 | 中 | 中 |
| 无问芯穹 | 低 | 无需抢购 | 稳定 | 中（聚合多模型） | 中（聚合多模型） |
| 摩尔线程 | 中 | 无轻量套餐 | 稳定 | 中 | 中 |
| Kimi | 高 | 无需抢购 | 稳定 | 强（Kimi-K2.5编程能力强） | 强 |
| 腾讯云 | 中 | Lite/Pro限量 | 稳定 | 中 | 中 |
| 京东云 | 中 | 有首月优惠 | 稳定 | 中 | 中 |
| 百度·千帆 | 中 | 无轻量套餐 | 稳定 | 中 | 强（支持百度搜索增强） |
| 快手·KwaiKAT | 中 | 限时特惠 | 稳定 | 中 | 中 |
...
| 小米·MiMo | Pro | [跳转](https://mimo.mi.com/) | ¥289.52 | ¥329 | - / 季 | - / 年 | MiMo-V2-Pro, MiMo-V2-Omni, MiMo-V2-TTS | 无限制 | 无限制 | 无限制 | TTS限时免费 | • 700M(7亿) Credits，无5小时限额，支持集中消耗 • 倍率 MiMo-V2-Omni:1x, Pro 256k:2x, Pro 1M:4x |
